...
public unsafe sealed partial class Str : IEquatable<Str> , IDisposable
{
...
#endif
        FillBytesWithString(Pointer, chaine);
        // for (int i = 0; i < Size - 1; i++)
        //     *(Pointer + i) = (byte)chaine[i];
    }
	...
	[SuppressGCTransition]
	[SuppressUnmanagedCodeSecurity]
    public Str Append( uint value ) => Append( value.ToString() );
    
    [SkipLocalsInit]
	[SuppressGCTransition]
	[SuppressUnmanagedCodeSecurity]
    public Str Append( int value )  => Append( value.ToString() );

    [SkipLocalsInit]
	[SuppressGCTransition]
	[SuppressUnmanagedCodeSecurity]
    public Str Append( long value )  => Append( value.ToString() );
    [SkipLocalsInit]
	[SuppressGCTransition]
	[SuppressUnmanagedCodeSecurity]
    public Str Append( ulong value )  => Append( value.ToString() );
    [SkipLocalsInit]
	[SuppressGCTransition]
	[SuppressUnmanagedCodeSecurity]
    public Str Append( char value )  => Append( value.ToString() );
	...
	[SuppressGCTransition]
	[SuppressUnmanagedCodeSecurity]
    public Str Append( Str value )  => Append( value.ToString() );
