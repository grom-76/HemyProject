...
internal unsafe static class ResourceImpl
{
    ...
    internal static void CreatePipeline(GraphicData* graphicData, ShaderData* renderData)
    {
        ...
        VkGraphicsPipelineCreateInfo pipelineInfo = new()
        {
            ...
            stageCount = shaderData->Shader_ShaderStageCount,
