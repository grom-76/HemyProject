...
public class A002_SoundAndTriggers : Base
{
    ...
    {
        base.Triggers.Add(0, base.Keyboard.IsPressed, Lib.Core.Input.Key.Escape, this.Close);
        base.Triggers.Add(1, base.Keyboard.IsPressed, Lib.Core.Input.Key.Space, this.Start);
        ...
        base.Triggers.Add(2, 2000, 3, sound2D.Play );
    }
