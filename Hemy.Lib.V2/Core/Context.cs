...
{
	public Window.WindowSettings Window => new(this);
	public Graphics.Graphic.GraphicSettings Graphic => new(this);
	...
	public void Dispose()
	{
		...
		// BUG  // FIXME: Add more collect kanpilotID(d7tf6zdjnvwchacf938c5eed)
	}
...
public unsafe sealed class Context : IDisposable
{
	...
	[SkipLocalsInit]
	public ConntextSettings Settings
	{
	...
	private long* WindowProcMessages(void* hWnd, uint message, uint* wParam, long* lParam) // ProcesEvents
	{
		...
		{
			// case WM_QUIT:
			case  WindowsEventsImpl.WM_CLOSE:
